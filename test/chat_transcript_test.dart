...
void main() {
  ...
  test('cancel tells the daemon to abort the operation', () async {
    ...
    expect(client.cancelledOps, [client.operationId],
  ...
  test('a user-requested stop keeps partial text and raises no error',
      () async {
    ...
    expect(last.error, isNull,
        reason: 'a deliberate stop is not a failure');
    expect(last.streaming, false);
  });
